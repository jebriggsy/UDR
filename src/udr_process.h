...
pid_t fork_execvp(const udr_args &cmd, int *p_to_c = nullptr,
                  int *c_to_p = nullptr);
pid_t fork_execvp(const std::string &what, const udr_args &cmd,
                  int *p_to_c = nullptr, int *c_to_p = nullptr);
pid_t fork_execvp_pty(const udr_args &cmd, int &master);
pid_t fork_execvp_pty(const std::string &what, const udr_args &cmd,
                      int &master);

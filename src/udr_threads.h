...
const int max_block_size =
    64 * 1024; // what should this be? maybe based on UDT buffer size?
...
template <typename T> class udr_memberthread : public udr_thread {
public:
  udr_memberthread(T &_inst, void *(T::*_member)(void))
      : inst(_inst), member(_member) {}

private:
  virtual void *thread_func() override { return (inst.*member)(); }
  T &inst;
  void *(T::*member)(void);
};
